...
import 'package:solar_app/model/category.dart';
import 'package:solar_app/model/image.dart';

class SolarHomePage extends StatefulWidget {
  const SolarHomePage({super.key});

  @override
  State<SolarHomePage> createState() => _SolarHomePageState();
}
  ...
  SizedBox selectCategory() {
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemCount: solarCategory.length,
